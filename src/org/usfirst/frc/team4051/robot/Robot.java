...
public class Robot extends TimedRobot {
	...
	TalonSRX motor1 = new TalonSRX(4);
...
;
	...
	public void robotInit() {
		...
		myRobot = new DifferentialDrive(new Victor(0), new Victor(1)); //PMW ports 0 & 1
	...
	public void teleopPeriodic() {
		myRobot.tankDrive(leftStick.getY(), rightStick.getY()*-1);
	...
	/**
	 * Anything bellow this message is usually pointless to edit.
	 */
